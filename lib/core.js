/*!
 * Bruit.io core library 2.0.13-plop <https://bruit.io>
 * Copyright (c) 2019 moventes <https://moventes.com>
...
(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var brtFieldType = createCommonjsModule(function (module, exports) {
    ...
    unwrapExports(brtFieldType);
    var brtFieldType_1 = brtFieldType.BrtFieldType;

    var brtPermissionName = createCommonjsModule(function (module, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    unwrapExports(brtPermissionName);
    var brtPermissionName_1 = brtPermissionName.BrtPermissionName;

    var brtPermissionStatus = createCommonjsModule(function (module, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var BrtPermissionStatus;
    (function (BrtPermissionStatus) {
        BrtPermissionStatus["GRANTED"] = "granted";
        BrtPermissionStatus["DENIED"] = "denied";
        BrtPermissionStatus["PROMPT"] = "prompt";
    })(BrtPermissionStatus = exports.BrtPermissionStatus || (exports.BrtPermissionStatus = {}));
    });

    unwrapExports(brtPermissionStatus);
    var brtPermissionStatus_1 = brtPermissionStatus.BrtPermissionStatus;
    ...
    var NavigatorTool = /** @class */ (function () {
        function NavigatorTool() {
        }
        NavigatorTool.navigatorDoesNotSupportsUtf16 = function () {
            var browser = Bowser.getParser(window.navigator.userAgent);
            return browser.satisfies({ safari: '>0', ie: '>0' });
        };
        NavigatorTool.getInfo = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, permissions, storage, privateMode, _b, cookieEnabled, userAgent, platform_1, language, network, plugins, serviceWorkersSupported, error_1;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            _a = _c.sent(), permissions = _a[0], storage = _a[1], privateMode = _a[2];
                            _b = window.navigator, cookieEnabled = _b.cookieEnabled, userAgent = _b.userAgent, platform_1 = _b.platform, language = _b.language;
                            network = this.getNetworkInformation();
                            plugins = this.getPluginsInformation();
                            serviceWorkersSupported = 'serviceWorker' in window.navigator;
                            return [2 /*return*/, {
        ...
        NavigatorTool.getNetworkInformation = function () {
            if ('connection' in window.navigator) {
                var _a = (window.navigator['connection']), downlink = _a.downlink, effectiveType = _a.effectiveType, type = _a.type;
                return { downlink: downlink, effectiveType: effectiveType, type: type };
            }
            else {
                return null;
            }
        };
        NavigatorTool.getPluginsInformation = function () {
            if ('plugins' in window.navigator) {
                var plugins = [];
                for (var i = 0; i < window.navigator.plugins.length; i++) {
                    var plugin = window.navigator.plugins.item(i);
                    if (plugin)
        ...
        NavigatorTool.getStorageInformation = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, quota, usage, error_2;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!('storage' in window.navigator)) return [3 /*break*/, 5];
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, window.navigator.storage.estimate()];
                        case 2:
                        ...
                        case 5: return [2 /*return*/, { quota: null, usage: null }];
                        case 6: return [2 /*return*/];
                    }
                });
            });
        };
        NavigatorTool.getCookies = function () {
            return document.cookie
                .split('; ')
                .map(function (c) { return c.split('='); })
                .filter(function (cookie) { return cookie.length === 2 && cookie[0][0] !== '_'; })
                .reduce(function (acc, cur) {
                acc[cur[0]] = cur[1];
                return acc;
            }, {});
        };
        NavigatorTool.getUrl = function () {
            return window.location.href;
        };
        NavigatorTool.getPermissions = function () {
            return __awaiter(this, void 0, void 0, function () {
                var permissionsQueries;
                return __generator(this, function (_a) {
                    // console.log('getInfo getPermissions');
                    if (navigator &&
                        navigator.permissions &&
                        navigator.permissions.query) {
                        permissionsQueries = Object.keys(brtPermissionName_1).map(function (permissionKey) {
                            // console.log('getInfo getPermissions query ', BrtPermissionName[permissionKey]);
                            return navigator.permissions
                                .query({ name: brtPermissionName_1[permissionKey] })
                                .then(function (pStatus) {
                                pStatus.name = brtPermissionName_1[permissionKey];
                                return pStatus;
                            })
                                .catch(function () { return Promise.resolve({ unsupported: true }); });
                        });
                        return [2 /*return*/, Promise.all(permissionsQueries).then(function (permisionsStatus) {
                                return permisionsStatus
                                    .filter(function (pStatus) {
                                    return !pStatus.unsupported &&
                                        pStatus.state !== brtPermissionStatus_1.PROMPT;
                                })
                                    .reduce(function (acc, pStatus) {
        ...
        NavigatorTool.getServiceWorkersList = function () {
            return __awaiter(this, void 0, void 0, function () {
                var registrations, error_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!('serviceWorker' in window.navigator)) return [3 /*break*/, 5];
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, registrations.map(function (registration) { return ({
        ...
        NavigatorTool.isIncognito = function () {
        ...
        NavigatorTool.getServiceWorkerState = function (registration) {
            var waiting = registration.waiting, installing = registration.installing, active = registration.active;
            return {
    ...
    */
    ...
    var renderElement = function (element, opts) { return __awaiter$1(_this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    resourceOptions = __assign$1({}, defaultResourceOptions, opts);
                    defaultOptions = {
                        backgroundColor: '#ffffff',
                    ...
                    options = __assign$1({}, defaultOptions, resourceOptions, opts);
    ...
    var ScreenTool = /** @class */ (function () {
        function ScreenTool() {
        }
        ScreenTool.getInfo = function () {
            return {
        ...
        ScreenTool.getScaleFromWidth = function (width) {
            return width / screen.width;
        };
        ScreenTool.getScaleFromHeight = function (height) {
            return height / screen.height;
        };
        ScreenTool.getScreenshot = function (screenshotConfig) {
            // console.log('getScreenshot go');
            return new Promise(function (resolve, reject) {
                // console.log('getScreenshot div');
                var div = screenshotConfig && screenshotConfig.elementToRenderSelector ? document.querySelector(screenshotConfig.elementToRenderSelector) : document.body;
                var options = {
                    background: 'white',
                ...
                var compression = 0.5;
                var scaleFromWidth = screenshotConfig && screenshotConfig.maxWidth ? ScreenTool.getScaleFromWidth(screenshotConfig.maxWidth) : window.devicePixelRatio;
                var scaleFromHeight = screenshotConfig && screenshotConfig.maxHeight ? ScreenTool.getScaleFromHeight(screenshotConfig.maxHeight) : window.devicePixelRatio;
                options.scale = Math.min(scaleFromWidth, scaleFromHeight);
                if (screenshotConfig && screenshotConfig.imageType)
                    imageType = screenshotConfig.imageType;
                if (screenshotConfig && screenshotConfig.compression)
                    compression = screenshotConfig.compression;
                try {
    ...
    var BRUIT_IO_API_URL = "https://api.bruit.io/feedback/multipart";
    var version = "2.0.6-plop";
    ...
    var Api = /** @class */ (function () {
        ...
        Api.postFeedback = function (feedback, apiUrl) {
            return new Promise(function (resolve, reject) {
                var formData = new FormData();
                var FeedbackCompressed;
                var compression;
                    ...
                    if (xhr.readyState === 4 || (xhr.readyState === 2 && xhr.status === 200)) {
                        if (JSON.stringify(xhr.status).startsWith('2') || xhr.status === 304) {
                            ...
                            try {
                                ...
                                reject(__assign({}, xhr, { code: 900, text: (body ? body.message : null) || 'An Unexpected Error Occurred' }));
                            }
                            catch (_a) {
                                reject(__assign({}, xhr, { code: 900, text: 'An Unexpected Error Occurred' }));
                            }
                        }
                    }
                };
    ...
    var Feedback = /** @class */ (function () {
        function Feedback(bruitCoreConfig) {
            this.apiUrl = BRUIT_IO_API_URL;
            this.apiUrl = bruitCoreConfig.apiUrl;
            this.version = version;
            if (bruitCoreConfig)
                this.apiKey = bruitCoreConfig.apiKey;
         ...
         * @param dataFn
         */
        Feedback.prototype.send = function (formFields, data, dataFn, screenshotConfig) {
            if (data === void 0) { data = []; }
            return __awaiter(this, void 0, void 0, function () {
                var agreementField, agreement, dataFromFn, formData, e_1;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 4, , 5]);
                            agreementField = formFields.find(function (field) { return field.id === 'agreement'; });
                            agreement = agreementField ? agreementField.value : false;
                            if (!agreement) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.setAgreementData(screenshotConfig)];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [4 /*yield*/, this.getDataFromFn(dataFn)];
                        case 3:
                            dataFromFn = _a.sent();
                            formData = formFields.map(function (field) { return _this.fieldToData(field); });
                            this.data = formData.concat(data, dataFromFn);
                            return [2 /*return*/, Api.postFeedback({
        ...
        Feedback.prototype.setAgreementData = function (screenshotConfig) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, screenShot, navigator, serviceWorkers;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), screenShot = _a[0], navigator = _a[1], serviceWorkers = _a[2];
                            ...
                            if (console.overloadable && console.overloaded && console.overloaded.logArray) {
                                this.logs = console.logArray();
                            }
                            else {
                                this.logs = [];
                            }
         ...
         */
        Feedback.prototype.getDataFromFn = function (dataFn) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // dataFn (function or promise)
                    if (dataFn) {
                        if (typeof dataFn === 'function') {
                            return [2 /*return*/, dataFn()];
                        }
         ...
         * @return a BrtData
         */
        Feedback.prototype.fieldToData = function (field) {
            var data = {
                type: field.type,
                value: field.value,
                label: field.label,
            ...
            if (data.type === brtFieldType_1.RATING) {
    ...
    var brtLogType = createCommonjsModule(function (module, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var BrtLogType;
    (function (BrtLogType) {
        BrtLogType["LOG"] = "log";
        BrtLogType["INFO"] = "info";
        BrtLogType["DEBUG"] = "debug";
        BrtLogType["WARN"] = "warn";
        BrtLogType["ERROR"] = "error";
        BrtLogType["NETWORK"] = "network";
        BrtLogType["CLICK"] = "click";
        BrtLogType["URL"] = "url";
    })(BrtLogType = exports.BrtLogType || (exports.BrtLogType = {}));
    });

    unwrapExports(brtLogType);
    var brtLogType_1 = brtLogType.BrtLogType;

    var SKIP_TAG = ['BR', 'WBR', 'STYLE', 'SCRIPT', 'HEAD', 'HTML', 'META'];
    var SKIP_CHILDREN = ['SVG'];
    var ClickTool = /** @class */ (function () {
        function ClickTool() {
        }
        /**
         ...
         */
        ClickTool.init = function () {
            var _this = this;
            window.addEventListener('click', function (event) {
                _this.logClick({
                    xpath: _this.getXPath(event['path']),
                    partialDom: ClickTool.domToString(event['srcElement'])
                });
            });
        };
        ClickTool.domToString = function (element, maxLevel) {
            if (maxLevel === void 0) { maxLevel = 3; }
            var elements = [];
            var currentElement = this.getChildElement(element);
            if (currentElement) {
                while (elements.length <= maxLevel) {
                    if (!(SKIP_TAG.indexOf(currentElement.tagName.toUpperCase()) >= 0)) {
            ...
            return elements
                .map(function (elem) { return ClickTool.elementToString(elem); })
                .map(function (elem, idx) { return "" + '&nbsp;'.repeat(2 * idx) + elem; })
                .join('<br>');
        };
        ClickTool.elementToString = function (element) {
            if (element.tagName) {
        ...
        ClickTool.getTextContent = function (element) {
            if (element.innerHTML) {
                var indexOfFirstTag = element.innerHTML.indexOf('<');
                var txt = void 0;
        ...
        ClickTool.elementToTagString = function (element) {
            var currentString = '';
            if (element.tagName)
                currentString += element.tagName.toLowerCase();
            if (element.id)
                currentString += " id=\"" + element.id + "\"";
            if (element.className && typeof element.className === 'string' && element.className.length)
                currentString += " class=\"" + element.className.split(' ')[0] + "...\"";
            if (element.getAttribute('type'))
                currentString += " type=\"" + element.getAttribute('type') + "\"";
            if (element.getAttribute('name'))
                currentString += " name=\"" + element.getAttribute('name') + "\"";
            if (element.getAttribute('href') && element.getAttribute('href') !== '#')
                currentString += " href=\"" + element.getAttribute('href') + "\"";
            if (element.getAttribute('value'))
                currentString += " value=\"" + element.getAttribute('value') + "\"";
         ...
         * @return string, xpath of clicked element
         */
        ClickTool.getXPath = function (path) {
            ...
            if (Array.isArray(path) && path.length >= 3) {
                ...
                path.some(function (element) {
                    xpathElements_1.push(ClickTool.getElementXpath(element));
                    return !!element.id;
                });
                return '//' + xpathElements_1.reverse().join('/');
            }
            else {
                return '//';
            }
         ...
         */
        ClickTool.getElementXpath = function (elem) {
            if (elem.id) {
         ...
         */
        ClickTool.indexOfElement = function (elem) {
         ...
         */
        ClickTool.getChildElement = function (element) {
            var currentElement = element;
            if (currentElement.hasChildNodes) {
                var firstChild = null;
                for (var i = 0; i < currentElement.children.length; i++) {
                    var child = currentElement.children.item(i);
                    if (!(SKIP_TAG.indexOf(child.tagName.toUpperCase()) >= 0) && !(SKIP_CHILDREN.indexOf(currentElement.tagName.toUpperCase()) >= 0)) {
                        firstChild = child;
                        break;
                    }
                }
        ...
        ClickTool.logClick = function () {
            ...
            if (console.click) {
                (_a = console).click.apply(_a, args);
            }
        };
        return ClickTool;
    }());

    var brtHttpRequest = createCommonjsModule(function (module, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var BrtHttpRequest;
    (function (BrtHttpRequest) {
        BrtHttpRequest["GET"] = "GET";
        BrtHttpRequest["POST"] = "POST";
        BrtHttpRequest["PUT"] = "PUT";
        BrtHttpRequest["PATCH"] = "PATCH";
        BrtHttpRequest["DELETE"] = "DELETE";
        BrtHttpRequest["UPDATE"] = "UPDATE";
        BrtHttpRequest["OPTIONS"] = "OPTIONS";
        BrtHttpRequest["CONNECT"] = "CONNECT";
        BrtHttpRequest["HEAD"] = "HEAD";
        BrtHttpRequest["TRACE"] = "TRACE";
    })(BrtHttpRequest = exports.BrtHttpRequest || (exports.BrtHttpRequest = {}));
    });

    unwrapExports(brtHttpRequest);
    var brtHttpRequest_1 = brtHttpRequest.BrtHttpRequest;

    var brtLogHttpType = createCommonjsModule(function (module, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var BrtLogHttpType;
    (function (BrtLogHttpType) {
        BrtLogHttpType["REQUEST"] = "request";
        BrtLogHttpType["RESPONSE"] = "response";
        BrtLogHttpType["RESPONSE_HEADER"] = "response-header";
    })(BrtLogHttpType = exports.BrtLogHttpType || (exports.BrtLogHttpType = {}));
    });

    unwrapExports(brtLogHttpType);
    var brtLogHttpType_1 = brtLogHttpType.BrtLogHttpType;

    var HttpTool = /** @class */ (function () {
        function HttpTool() {
        }
        HttpTool.init = function (addQueryParamsToLog) {
            if (addQueryParamsToLog === void 0) { addQueryParamsToLog = false; }
            HttpTool.overrideXMLHttpRequest();
            HttpTool.overrideFetch();
            HttpTool.addQueryParamsToLog = addQueryParamsToLog;
        };
        HttpTool.overrideXMLHttpRequest = function () {
            (function (open) {
        ...
        HttpTool.overrideFetch = function () {
            (function (fetchP) {
        ...
        HttpTool.logCall = function (method, url, headers, body) {
            var requestLog = {
                type: brtLogHttpType_1.REQUEST,
                timestamp: new Date(),
                method: brtHttpRequest_1[method.toUpperCase()],
        ...
        HttpTool.logResponse = function (method, url, status, response, timestamp) {
            var requestLog = {
                type: brtLogHttpType_1.RESPONSE,
        ...
        HttpTool.logResponseHeaders = function (method, url, status, timestamp) {
            var requestLog = {
                type: brtLogHttpType_1.RESPONSE_HEADER,
                timestamp: timestamp || new Date(),
                method: brtHttpRequest_1[method.toUpperCase()],
                url: url,
                status: status
        ...
        HttpTool.logHttp = function (requestLog) {
            if (console.network) {
                console.network(JSON.decycle(requestLog));
            }
        };
        return HttpTool;
    }());
    ...
    var UrlTool = /** @class */ (function () {
        ...
        UrlTool.init = function () {
            var _this = this;
            if ('onhashchange' in window) {
                window.addEventListener('hashchange', function () {
                    _this.logUrl(window.location.href);
                });
                this.logUrl(window.location.href);
            }
        };
        UrlTool.logUrl = function () {
            var _a;
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i] = arguments[_i];
    ...
    var ConsoleTool = /** @class */ (function () {
        function ConsoleTool() {
        }
        ConsoleTool.init = function (logConfig) {
            if (!(!!window.cordova ||
                (document.URL.indexOf('http://localhost') !== 0 && document.URL.indexOf('http://127.0.0.1') !== 0))) {
                console.overloadable = false;
                console.info('BRUIT.IO - logs reports are disabled in localhost mode');
            }
            else {
                console.overloadable = true;
            }
            console.overloadable = true;
            ConsoleTool.logConfig = logConfig;
            ConsoleTool.configure();
        };
        ConsoleTool.addEventHandlers = function () {
            if (console.overloadable) {
        ...
        ConsoleTool.configure = function () {
            ...
            if (typeof JSON.retrocycle !== 'function') {
                JSON.retrocycle = function retrocycle($) {
                    var pathTest = /^\$(?:\[(?:\d+|'(?:[^\\'\u0000-\u001f]|\\([\\'\/bfnrt]|u[0-9a-zA-Z]{4}))*')\])*$/;
                    (function rez(value) {
                            ...
                            if (Array.isArray(value)) {
                                value.forEach(function (element, i) {
                                    if (typeof element === 'object' && element !== null) {
                                        ...
                                        if (typeof path === 'string' && pathTest.test(path)) {
            ...
            if (console.overloadable) {
                ...
                if (!console.overloaded.logArray) {
                    console.overloaded.logArray = true;
                    console.logArray = function () {
                        return Object.keys(ConsoleTool.logConfig.logCacheLength)
                            .filter(function (key) { return ConsoleTool.logConfig.logCacheLength[key] > 0 && ConsoleTool.logByLevel[key]; })
                            .map(function (key) { return ConsoleTool.logByLevel[key]; })
                            .reduce(function (logArray, logsLevel) { return logArray.concat(logsLevel); }, [])
                            .sort(function (logA, logB) { return logA.timestamp.getTime() - logB.timestamp.getTime(); });
                    };
                }
                if (!console.overloaded.click) {
                    console.overloaded.click = true;
                    console.click = function () {
                        return ConsoleTool.handleLogMessage(brtLogType_1.CLICK, arguments);
                    };
                    ClickTool.init();
                }
                if (!console.overloaded.url) {
                    console.overloaded.url = true;
                    console.url = function () {
                        return ConsoleTool.handleLogMessage(brtLogType_1.URL, arguments);
                    };
                    UrlTool.init();
                }
                if (!console.overloaded.network) {
                    console.overloaded.network = true;
                    console.network = function () {
                        return ConsoleTool.handleLogMessage(brtLogType_1.NETWORK, arguments);
                    };
                    HttpTool.init(ConsoleTool.logConfig.addQueryParamsToLog);
                }
                if (!console.overloaded.log) {
                    console.overloaded.log = true;
                    var _log_1 = console.log;
                    console.log = function () {
                        return _log_1.apply(console, ConsoleTool.handleLogMessage(brtLogType_1.LOG, arguments));
                    };
                }
                if (!console.overloaded.debug) {
                    console.overloaded.debug = true;
                    var _debug_1 = console.debug;
                    console.debug = function () {
                        return _debug_1.apply(console, ConsoleTool.handleLogMessage(brtLogType_1.DEBUG, arguments));
                    };
                }
                if (!console.overloaded.error) {
                    console.overloaded.error = true;
                    var _error_1 = console.error;
                    console.error = function () {
                        var args = ConsoleTool.handleLogMessage(brtLogType_1.ERROR, arguments);
                        args.push(new Error().stack);
                        return _error_1.apply(console, args);
                    };
                }
                if (!console.overloaded.warn) {
                    console.overloaded.warn = true;
                    var _warn_1 = console.warn;
                    console.warn = function () {
                        return _warn_1.apply(console, ConsoleTool.handleLogMessage(brtLogType_1.WARN, arguments));
                    };
                }
                if (!console.overloaded.info) {
                    console.overloaded.info = true;
                    var _info_1 = console.info;
                    console.info = function () {
                        return _info_1.apply(console, ConsoleTool.handleLogMessage(brtLogType_1.INFO, arguments));
                    };
                }
                ConsoleTool.addEventHandlers();
            }
        };
        ConsoleTool.handleLogMessage = function (type, args) {
            if (type && args && args.length > 0) {
                var parentArgs = Array.from(args);
                var currentLog_1 = {
                    type: type,
                    timestamp: new Date(),
                    arguments: []
                };
                parentArgs.forEach(function (arg) {
                    if (typeof arg === 'object') {
                        try {
                            arg = JSON.stringify(JSON.decycle(arg));
                        }
                        catch (err) {
                            arg = '';
                        }
                    }
                    currentLog_1.arguments.push(arg);
                });
                if (!Array.isArray(ConsoleTool.logByLevel[currentLog_1.type])) {
                    ConsoleTool.logByLevel[currentLog_1.type] = [];
                }
                ConsoleTool.logByLevel[currentLog_1.type].push(currentLog_1);
                if (ConsoleTool.logByLevel[currentLog_1.type].length > ConsoleTool.logConfig.logCacheLength[currentLog_1.type]) {
                    ConsoleTool.logByLevel[currentLog_1.type].shift();
                }
                return parentArgs;
            }
            else {
        ...
        ConsoleTool.logByLevel = {};
        return ConsoleTool;
    }());

    var BruitCoreConfig = /** @class */ (function () {
        function BruitCoreConfig(config) {
            this.apiUrl = BRUIT_IO_API_URL;
            this.log = {
                logCacheLength: {
                    log: 100,
            ...
            if (config && config.log && config.log.logCacheLength) {
                this.log.logCacheLength = __assign({}, this.log.logCacheLength, config.log.logCacheLength);
        ...
        BruitCoreConfig.haveError = function (config) {
            if (config) {
                if (config.log && config.log.logCacheLength) {
                    if (!Object.keys(config.log.logCacheLength).every(function (v) { return config.log.logCacheLength[v] >= 0; })) {
                        return {
                            code: 101,
                ...
                if (!config.apiKey && (!config.apiUrl || config.apiUrl === BRUIT_IO_API_URL)) {
                    return {
                        code: 101,
        ...
        return BruitCoreConfig;
    }());

    var Bruit = /** @class */ (function () {
        function Bruit() {
        }
        Bruit.init = function (config, loadBruitModal, modalConfig) {
            if (loadBruitModal === void 0) { loadBruitModal = true; }
            var errors = BruitCoreConfig.haveError(config);
            if (!errors) {
                var bruitCoreConfig = new BruitCoreConfig(config);
        ...
        // }
        Bruit.getConfig = function () {
            return Bruit.config;
        };
        Bruit.openModal = function (bruitIoConfig, data, dataFn) {
            var modal = document.querySelector('bruit-modal');
            if (modal && modal.open) {
                return modal.open(bruitIoConfig, data, dataFn);
            }
        };
        Bruit.sendFeedback = function (data, dataFn, agreement, screenshotConfig) {
            if (data === void 0) { data = []; }
            if (agreement === void 0) { agreement = false; }
        ...
        Bruit.sendFeedbackFromModal = function (formFields, data, dataFn, screenshotConfig) {
            if (data === void 0) { data = []; }
            var feedback = new Feedback(Bruit.config);
            return feedback.send(formFields, data, dataFn, screenshotConfig);
        };
        Bruit.sendError = function (error) {
    ...
    if (document && document.getElementsByTagName) {
        ...
        // Find our script
        var reg = /https:\/\/unpkg\.com\/@bruit\/core@.*\/lib\/core\.js\?/;
        var scriptUnpkg = null;
        for (var i$1 = 0; i$1 < scripts.length; i$1++) {
            if (scripts[i$1].src && scripts[i$1].src.search(reg) === 0) {
                scriptUnpkg = scripts[i$1].src;
            }
        }
        if (scriptUnpkg) {
            var loadBruitModal = true;
            var modalConfig = void 0;
            // split our script
